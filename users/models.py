...
class Fraction(models.Model):
    ...
    leader = models.OneToOneField(User, verbose_name="Лидер", blank=True, null=True, related_name="faction_lead",
                                  on_delete=models.SET_NULL)
    deputy_leader = models.OneToOneField(User, verbose_name="Заместитель лидера", blank=True, null=True,
    ...
    rng_weapons = models.ManyToManyField(Weapon, related_name="faction_wpn", verbose_name="Ассортимент оружия",
                                         help_text="1 слот", blank=True)
    rng_pistols = models.ManyToManyField(Pistol, related_name="faction_pst", verbose_name="Ассортимент оружия",
                                         help_text="2 слот", blank=True)
    rng_outfits = models.ManyToManyField(Outfit, related_name="faction_bron", verbose_name="Ассортимент брони",
                                         blank=True)
    rng_ammo1 = models.ManyToManyField(Ammo, related_name="faction_w_ammo", verbose_name="Ассортимент боеприпасов",
                                       help_text="1 слот", blank=True)
    rng_ammo2 = models.ManyToManyField(PistolAmmo, related_name="faction_p_ammo",
    ...
    сan_entry = models.BooleanField(default=True, verbose_name="Возможность вступления")
